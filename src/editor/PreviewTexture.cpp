...
rt::editor::PreviewTexture::PreviewTexture(::Texture texture, int availableWidth, int availableHeight)
    : texture(texture),
...
rt::editor::PreviewTexture::~PreviewTexture() { UnloadTexture(texture); }

auto rt::editor::PreviewTexture::GetImTextureID() const -> ImTextureID {
  return reinterpret_cast<ImTextureID>(&texture.id);
}

auto rt::editor::PreviewTexture::FitIntoArea(ImVec2 availableArea, ImVec2 textureSize) -> ImVec2 {
...
auto rt::editor::PreviewTexture::ShouldResize(ImVec2 availableArea) const -> bool {
